...
export function RealmCarousel() {
  ...
  return (
    <section id="carousel" className="relative w-full overflow-hidden bg-[#020d08]" style={{ height: '90vh', minHeight: 540 }}>
      ...
      <AnimatePresence initial={false} custom={direction} mode="sync">
        ...
        >
          ...
          <img
            ...
            style={{ filter: 'brightness(1) saturate(1.1)' }}
            draggable={false}
          />

          {/* Gradient overlays */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#020d08] via-[#020d08]/60 to-transparent" />
          {/* Grain texture */}
          <div
